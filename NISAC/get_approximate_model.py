...
reward_list=[5000,5000,5000,5000,5000,5000,5000,5000,5000,5000]

def get_best_model(model_name='Walker2d-v2',exp_name='grad-norm'):
    global seed
    global reward_list
    """
    ...
    os.makedirs(f'./approximate_model/{exp_name}/{model_name}', exist_ok=True)
    
    # 遍历主目录下的所有子目录
    for subdir in os.listdir(model_dir):
        
        # 创建目标目录结构，但不复制文件
        target_subdir_path = os.path.join(f'./approximate_model/{exp_name}/{model_name}', subdir)
