...
def test_policy(env_name, agent, DISTURBANCE_DICT, writer):
    ...
    for friction in friction_list:
        ...
        reward_list.append(reward)
        print(reward)
    np.save('./data_evaluate/NISAC_{}_{}.npy'.format(env_name, 'friction_agent_2500'),
...
def main_test(args, agent_args):
    ...
    agent = NISAC(writer, device, state_dim, action_dim, agent_args)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_interval", type=int, default=50000, help='save interval(default: 100000)')
