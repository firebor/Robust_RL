...
# seeds=(1234 5678 9012 3456 7890 2345 6789 1235 6780 2346)
max_processes=5


Path_prefix="train_result"
env_name="Walker2d-v2"
exp_name="Adam-optimizer"  # 添加实验名称参数
log_dir="script_logs"
...
for seed in "${seeds[@]}"; do
    ...
    # 启动实验并将输出重定向到日志文件
    nohup python main.py --seed=$seed --exp_name=$exp_name --env_name=$env_name > "$log_file" 2>&1 &
    
    echo "启动实验 $((++count)): seed=$seed, exp_name=$exp_name"
