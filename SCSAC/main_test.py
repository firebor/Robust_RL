...
def evaluate_policy(env, agent):
    times = 50  # Perform three evaluations and calculate the average
    evaluate_reward = 0
...
def get_model_path(env_name,seed):
    # 在best_model下找对应的文件夹
    model_dir = f'./best_model/{env_name}'
...
def main_test(args, agent_args):
    ...
    # model_path='./best_model/Walker2d-v2/Walker2d-v2_sac_seed42_noise0.1/agent_2500_5211'
    ...
    print(f"============使用SCSAC算法，seed={args.seed}")
