...
def worker(args):
    ...
    try:
        ...
        agent_args = Dict(config, 'sac')  # 使用scsac配置
        ...
        # 创建智能体
        agent = SCSAC(None, device, state_dim, action_dim, agent_args)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--algo", type=str, default='sac', help='algorithm to adjust (default : scsac)')
