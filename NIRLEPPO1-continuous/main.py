...
def main(args):
    ...
    log_dir_temp = f'./train_result/{args.exp_name}/{args.env_name}/tensorboard_logs/{args.env_name}_PPO_seed{args.seed}_sw{args.switch_steps}'
    ...
    # Set log file paths
    if counter == 0:
        log_log_dir = f'./train_result/{args.exp_name}/{args.env_name}/logs_logs/{args.env_name}_PPO_seed{args.seed}_sw{args.switch_steps}.log'
        model_dir = f'./train_result/{args.exp_name}/{args.env_name}/model_weights/{args.env_name}_PPO_seed{args.seed}_sw{args.switch_steps}'
    else:
        log_log_dir = f'./train_result/{args.exp_name}/{args.env_name}/logs_logs/{args.env_name}_PPO_seed{args.seed}_sw{args.switch_steps}({counter}).log'
        model_dir = f'./train_result/{args.exp_name}/{args.env_name}/model_weights/{args.env_name}_PPO_seed{args.seed}_sw{args.switch_steps}({counter})'
    ...
    while total_steps < args.max_train_steps:
        ...
        while not done:
            ...
            if replay_buffer.count == args.batch_size:
                if(add_noise_step % args.switch_steps == 0):
                    is_add_noise = True
                    add_noise_step =0
                else:
                    is_add_noise = False

                agent.update(replay_buffer,total_steps,is_add_noise)
    ...
    if args.use_state_norm:
        norm_stats_dir = f'./train_result/{args.exp_name}/{args.env_name}/normalization_stats/{args.env_name}_PPO_seed{args.seed}_sw{args.switch_steps}'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--exp_name", type=str, default="RLE", help="Name of the experiment")
    ...
    parser.add_argument("--switch_steps", type=int, default=500, help="加噪声的步数")
